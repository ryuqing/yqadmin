												...
												{{csrf_field()}}
													...
													<label class="block clearfix">
														<span class="block input-icon ">
															...
															<img style="cursor:pointer;" src="{{url('admin/code')}}" width="100" height="30" title="看不清楚？点击刷新" onclick="this.src = '{{url('admin/code')}}?'+new Date().getTime()">
														</span>
													</label>
